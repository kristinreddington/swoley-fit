  ...
  return (
    ...
    >
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={"bg-slate-950 border py-3 rounded-lg duration-200 hover:border-blue-600 px-4" 
      ...
      <div className="bg-slate-950 border border-solid border-blue-400 rounded-lg flex flex-col">
        <button onClick={toggleModal} className="relative felx items-center justify-center p-3">
